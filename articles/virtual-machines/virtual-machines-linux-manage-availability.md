...
<!--Image reference-->
   ![UD FD configuration](./media/virtual-machines-linux-manage-availability/ud-fd-configuration.png)
...
<!--Image reference-->
   ![Application tiers](./media/virtual-machines-linux-manage-availability/application-tiers.png)
